export const paymentMethods = [
  { id: 'visa', name: 'Visa', category: 'Card payments', description: 'Use your Visa card through the funding options in your account. Review the amount and payment details before confirming.' },
