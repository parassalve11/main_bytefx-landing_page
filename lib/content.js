...
export const site = {
  ...
  /** Real client-area destinations, used by the header and every CTA. */
  loginUrl: 'https://my.bytefx.com/login',
  liveAccountUrl: 'https://my.bytefx.com/register',
  demoAccountUrl: 'https://my.bytefx.com/register',
  registerUrl: 'https://my.bytefx.com/register',
  partnerPortalUrl: 'https://partner.bytefx.com/',
...
export const navigation = [
  {
    ...
    feature: {
      image: artwork.platforms.dark, lightImage: artwork.platforms.light,
  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { label: 'Currency Converter', note: 'Real-time exchange rates', href: '/tools/calculator' },
          { label: 'Trading Calculator', note: 'Calculate margin, pips & swaps', href: '/tools/trading-calculator' },
          { label: 'Economic Calendar', note: 'Key market-moving events', href: '/tools/calendar' },
          { label: 'Market Quotes', note: 'Real-time price tracking', href: '/tools/quotes' },
        ],
      },
    ],
    feature: {
      image: artwork.marketAccess.dark, lightImage: artwork.marketAccess.light,
      alt: 'Glass globe with gold bars and blue market chart columns',
    ...
    groups: [
      {
        ...
        items: [
          { label: 'Trading school', note: 'Practical lessons from first trade onward.', href: null },
          { label: 'Market news', note: 'Stay current with the stories moving markets.', href: null },
          { label: 'Economic calendar', note: 'Plan around important global events.', href: '/tools/calendar' },
        ],
      },
    ],
    feature: {
      image: artwork.calendar.dark, lightImage: artwork.calendar.light,
      alt: 'Blue glass calendar with a silver clock and an economic chart',
      title: 'Plan your trading week',
      note: 'Explore upcoming economic events.',
      href: '/tools/calendar',
    },
  },
  {
    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: 'Why choose us', href: '/why-bytefx' },
          { label: 'Contact us', href: '/contact' },
        ],
      },
    ],
    feature: {
      image: artwork.trust.dark, lightImage: artwork.trust.light,
      alt: 'Blue crystal shield and silver padlock on a glass plinth',
      title: 'Built around trust',
      note: 'Get to know the team behind your account.',
      href: '/about',
    },
  },
...
export const documents = [
  { id: 'terms', label: 'Terms & Conditions', note: 'The agreement that governs your account and trading.', href: pdf('ByteFX Capital Ltd - Terms & Conditions latest') },
  ...
  slides: [
    {
      ...
      primary: { label: 'Explore more', href: '/#broker' },
    },
    {
      id: 'stay-cool',
      label: 'Stay cool',
    ...
    },
    {
      ...
      accent: '',
      body: 'From gold to the world’s most-traded currency pairs, reach 150+ instruments from one account, with tight spreads and fast execution.',
      art: {
...
export const bento = {
  markets: {
    ...
    body:
      'Gold, silver, oil and energy — plus Forex, Indices, Shares and Crypto, all from one account.',
    image: artwork.tradeGlobal.dark, lightImage: artwork.tradeGlobal.light,
    width: 1000,
    height: 1055,
    alt: 'Glass panels for Shares, Forex, Commodities, Crypto and Indices behind fine gold and silver bars, and Ethereum and Solana coins',
  },
  ...
  refer: {
    ...
    body: 'Invite traders to join you and unlock greater opportunities together.',
...
export const broker = {
  ...
  cards: [
    ...
    },
    {
      ...
      value: 'More choice',
      note: 'Standard, Pro and Custom account options',
      image: '/assets/accounts/folder-dark.webp',
      lightImage: '/assets/accounts/folder-light.webp',
      alt: 'A glass folder holding Standard, Pro and Custom account tabs',
    },
    {
      id: 'demo',
...
export const cta = {
  ...
  lead: 'Your next chapter starts here.',
  primary: { label: 'Open live account', href: site.registerUrl },
...
export const footer = {
  ...
  marquee: 'Discover your trading edge · Trade global markets · ',
  socials: [
  ...
  policies: [
    ...
    { label: 'Legal & Compliance', href: documents[4].href },
  ],
