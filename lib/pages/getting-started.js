...
export const setupSteps = [
  {
    ...
    tip: 'Registration takes a few clicks in the client area. Support can help if anything gets stuck.',
...
export const gettingStartedFaqs = [
  ...
  ['Can I practise before trading with real money?', 'Yes. Free demo accounts with virtual funds can be opened from the client area, so you can test the platform before going live.'],
