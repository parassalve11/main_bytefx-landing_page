...
export const markets = [
  {
    ...
    hero: { art: '/assets/markets/heroes/forex.webp', alt: 'Silver dollar, euro and pound coins around a blue glass globe', title: 'Trade the global', accent: 'currency markets.', lede: 'Access 24/5 forex trading on MetaTrader 5, with deep liquidity, spreads from 0.0 pips and leverage up to 1:2000*.' },
    instruments: {
  ...
  },
  {
    ...
    hero: { art: '/assets/markets/heroes/crypto.webp', alt: 'Gold Bitcoin coin and silver Ethereum emblem with blue glass discs', title: 'Trade crypto', accent: 'around the clock.', lede: 'Take a view on Bitcoin, Ethereum and other leading cryptocurrencies as CFDs, seven days a week, with no wallet to manage.' },
    instruments: {
  ...
  },
  {
    ...
    hero: { art: '/assets/markets/heroes/stocks.webp', alt: 'Silver corporate towers on blue glass blocks beside an equity certificate', title: 'Trade the world’s', accent: 'leading companies.', lede: 'CFDs on global blue chips with real-time data. Go long or short on the companies you follow, from one account.' },
    instruments: {
  ...
  },
  {
    ...
    hero: { art: '/assets/markets/heroes/commodities.webp', alt: 'Gold and silver bars with wheat and coffee beans on a blue glass disc', title: 'Trade gold, silver', accent: 'and soft commodities.', lede: 'Diversify with precious metals and softs such as coffee, sugar and cotton, markets that often move differently from shares.' },
    instruments: {
  ...
  },
  {
    ...
    hero: { art: '/assets/markets/heroes/indices.webp', alt: 'Blue glass benchmark columns surrounding a silver globe', title: 'Trade whole markets', accent: 'in one position.', lede: 'CFDs on the world’s leading stock indices. Take a view on an entire market instead of picking companies one by one.' },
    instruments: {
  ...
  },
  {
    ...
    hero: { art: '/assets/markets/heroes/energy.webp', alt: 'Graphite and silver oil barrels beside a blue glass natural gas flame', title: 'Trade crude oil', accent: 'and natural gas.', lede: 'CFDs on WTI, Brent and natural gas, with prices that react to supply decisions, inventories and the weather.' },
    instruments: {
