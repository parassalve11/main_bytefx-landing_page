...
export const marketsPage = {
  ...
  title: 'Every market', accent: 'One account',
  ...
  stats: [['150+', 'Tradable instruments'], ['1:2000*', '* Maximum leverage depends on market volatility.'], ['0.0 pips', 'Raw spreads from'], ['~20 ms', 'Average execution']],
};
...
export const markets = [
  {
    ...
    image: artwork.forex.dark, lightImage: artwork.forex.light, alt: 'forex market sculpture',
    hero: { art: artwork.forex.dark, lightArt: artwork.forex.light, alt: 'Silver dollar, euro and pound coins around a glass globe', title: 'Trade the global', accent: 'currency markets', lede: 'Access 24/5 forex trading on MetaTrader 5, with deep liquidity, spreads from 0.0 pips and leverage up to 1:2000*.' },
    instruments: {
  ...
  },
  {
    ...
    image: artwork.crypto.dark, lightImage: artwork.crypto.light, alt: 'crypto market sculpture',
    hero: { art: artwork.crypto.dark, lightArt: artwork.crypto.light, alt: 'Gold Bitcoin coin and silver Ethereum emblem with glass discs', title: 'Trade crypto', accent: 'around the clock', lede: 'Take a view on Bitcoin, Ethereum and other leading cryptocurrencies as CFDs, seven days a week, with no wallet to manage.' },
    instruments: {
    ...
    faqs: [
      ...
      ['Which cryptocurrencies can I trade?', 'Bitcoin, Ethereum and other leading cryptocurrencies are available. The full list is in MetaTrader 5.'],
  ...
  },
  {
    ...
    image: artwork.stocks.dark, lightImage: artwork.stocks.light, alt: 'stocks market sculpture',
    hero: { art: artwork.stocks.dark, lightArt: artwork.stocks.light, alt: 'Silver corporate towers on glass blocks beside an equity certificate', title: 'Trade the world’s', accent: 'leading companies', lede: 'CFDs on global blue chips with real-time data. Go long or short on the companies you follow, from one account.' },
    instruments: {
  ...
  },
  {
    ...
    image: artwork.commodities.dark, lightImage: artwork.commodities.light, alt: 'Gold, silver and copper bars with oil barrels and mineral ore on a glass disc',
    hero: { art: artwork.commodities.dark, lightArt: artwork.commodities.light, alt: 'Gold, silver and copper bars with oil barrels and mineral ore on a glass disc', title: 'Trade gold, silver', accent: 'and soft commodities', lede: 'Diversify with precious metals and softs such as coffee, sugar and cotton, markets that often move differently from shares.' },
    instruments: {
  ...
  },
  {
    ...
    image: artwork.indices.dark, lightImage: artwork.indices.light, alt: 'indices market sculpture',
    hero: { art: artwork.indices.dark, lightArt: artwork.indices.light, alt: 'glass benchmark columns surrounding a silver globe', title: 'Trade whole markets', accent: 'in one position', lede: 'CFDs on the world’s leading stock indices. Take a view on an entire market instead of picking companies one by one.' },
    instruments: {
    ...
    faqs: [
      ...
      ['Which indices can I trade?', 'CFDs on leading global indices are available. The full list and each symbol’s details are in MetaTrader 5.'],
  ...
  },
  {
    ...
    image: artwork.energy.dark, lightImage: artwork.energy.light, alt: 'energy market sculpture',
    hero: { art: artwork.energy.dark, lightArt: artwork.energy.light, alt: 'Graphite and silver oil barrels beside a glass natural gas flame', title: 'Trade crude oil', accent: 'and natural gas', lede: 'CFDs on WTI, Brent and natural gas, with prices that react to supply decisions, inventories and the weather.' },
    instruments: {
...
/* The object Breadcrumbs, PageSchema and pageMetadata expect. */
...
export const marketsFaqs = [
  ['What markets can I trade?', 'You can trade forex, crypto, stocks, commodities, indices and energy — 150+ instruments from a single secure account on MetaTrader 5.'],
  ['What are the major currency pairs?', 'The majors pair the US dollar with the other most-traded currencies, such as EUR/USD, GBP/USD, USD/JPY, USD/CHF and AUD/USD.'],
