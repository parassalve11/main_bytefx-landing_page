...
import { PageHero, SectionHead, FAQ, PageSchema, pageMetadata } from '@/components/inner/page-kit';
import { AccountFinder, StickySubnav } from '@/components/inner/interactions';
import { site } from '@/lib/content';
import { accountPage as page, accountFaqs } from '@/lib/pages/account-types';

export const metadata = pageMetadata(page);
const sections = [['account-options', 'The accounts'], ['find-account', 'Find your fit'], ['included', 'Included'], ['faq', 'FAQs']];
const included = [
  ...
  return <main id="main" className="inner-page account-types-page">
    ...
    <section className="band" id="account-options"><div className="shell">
      <div className="section-head inner-section-head section-head--center">
        ...
        <h2 className="h-lg">Same ByteFX.<br /><span className="tint">Your kind of trading.</span></h2>
    ...
    <section className="band" id="included"><div className="shell">
      <SectionHead eyebrow="Built into every account" title="The essentials." accent="Already included." />
    ...
    <FAQ items={accountFaqs} />
    <ClosingSection title="Your next move." accent="Your account." lead="Open a ByteFX account in minutes and start with as little as $20." primary={{ label: 'Open your account', href: site.registerUrl }} secondary={{ label: 'Contact for a custom plan', href: '/contact' }} />
  </main>;
}
