...
import { Actions, FAQ, PageHero, PageSchema, SectionHead, ThemeArt, pageMetadata } from '@/components/inner/page-kit';
import { CompanyFacts, IconGrid, PhotoBand } from '@/components/inner/site-sections';
import { site } from '@/lib/content';
import { aboutFaqs, aboutPage as page, values } from '@/lib/pages/company';
...
export default function AboutPage() {
  return <main id="main" className="inner-page about-page">
    <PageSchema page={page} faqs={aboutFaqs} />
    <PageHero page={page} />
    ...
    <section className="mobile-section inner-color-band" id="community"><div className="shell inner-split">
      <div><p className="eyebrow">ByteFX on Telegram</p><h2 className="h-lg">Never trade alone.</h2><p className="lede">Join 5,000+ active traders in our official Telegram community. Get real-time market updates, trade ideas and technical analysis directly from our team — and connect with traders at every level.</p><Actions primary={{ label: 'Join the Telegram community', href: site.telegramUrl }} /></div>
      <ThemeArt src="/assets/broker/sculptures/support.webp" light="/assets/broker/sculptures/blue/support.webp" alt="" sizes="(max-width: 760px) 70vw, 460px" className="band-art" />
    </div></section>
    <FAQ items={aboutFaqs} title="About ByteFX, in brief." />
