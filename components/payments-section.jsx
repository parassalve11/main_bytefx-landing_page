        ...
        <Reveal className="payments-layout">
          <div className="payments-story">
            ...
            <div className="payment-scene">
              ...
              <Image className="payment-scene__wallet theme-art--light" src="/assets/generated/blue/wallet-payment-methods.webp" alt="A graphite and blue wallet with payment-brand coins in their original colours" width={1223} height={1286} sizes="(max-width: 760px) 86vw, 480px" />
            </div>
          </div>
