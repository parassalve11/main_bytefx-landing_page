...
export function StoreBadge({ apple = false }) {
  const content = <>{apple ? <svg width="25" height="29" viewBox="0 0 24 28" fill="currentColor" aria-hidden="true"><path d="M16 0c.3 3-1.7 5.6-4.4 5.7C11.3 3 13.5.4 16 0ZM21 20c-.8 2.2-3.5 6.4-5.6 6.5-1.4.1-2-1-4-1s-2.8 1-4.2 1C4.4 26.4.5 20.5.5 14.8.5 10.3 3 7.5 6.2 7.5c1.8 0 3.2 1.1 4.5 1.1 1.1 0 3-1.3 5.1-1.1 1.8.1 3.5.8 4.6 2.2-4 2.4-3.6 8.1.6 10.3Z" /></svg> : <svg width="26" height="28" viewBox="0 0 512 512" aria-hidden="true"><path fill="#00f076" d="M325.3 234.3 104.6 13l280.8 161.2-60.1 60.1Z"/><path fill="#00d3ff" d="M47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0Z"/><path fill="#ffc900" d="m472.2 225.6-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8Z"/><path fill="#f43249" d="M104.6 499 385.4 337.8l-60.1-60.1L104.6 499Z"/></svg>}<span><small>{apple && !site.iosAppUrl ? 'COMING SOON ON' : apple ? 'Download on the' : 'GET IT ON'}</small><b>{apple ? 'App Store' : 'Google Play'}</b></span></>;
